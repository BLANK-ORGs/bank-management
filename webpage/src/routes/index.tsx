...
const EmpolyeeMaster = React.lazy(
	() => import('../pages/MasterFiles/EmployeeMaster')
)
const AreaMaster = React.lazy(() => import('../pages/MasterFiles/AreaMaster'))
const CustomerMaster = React.lazy(
	() => import('../pages/MasterFiles/CustomerMaster')
)
const GuarantorMaster = React.lazy(
	() => import('../pages/MasterFiles/GuarantorMaster')
)
const Loan = React.lazy(() => import('../pages/Transactions'))
const UserDashboardReport = React.lazy(
	() => import('../pages/Reports/UserDashboard')
)
...
const UserPermissions = React.lazy(
	() => import('../pages/Setting/UserPermissions')
)
...
const LoanDetails = React.lazy(
	() => import('../pages/Reports/LoanDetailsReport')
)
const SingleLoan = React.lazy(
	() => import('../pages/Reports/LoanDetailsReport/loan')
)
